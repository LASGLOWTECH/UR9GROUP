...
<img className="w-75   h-75" src="" id ="img1" alt="image"></img>
            ...
            <div className="services-section bg-dark text-light " id="values">
                <div className="row mb-5 mx-1">
                    <div className="col-12 Short-note  align-items-center text-center ">
                        ...
                        <div className="container-fluid  w-75 "><p className="mx-4  val-text text-center fs-normal lh-lg " > We are your one-stop destination for premium homes,exquisite vodka, and sustainable construction. Our core values help us to provide our clients
    ...
    <div className="About-section " id="About-section">
        <div className="row  py-5">
            ...
            <div id="prop-items" className=   " col-lg-6   px-5 py-4"><img className="w-100 " src="/drinks.jpg" ></img></div>
            ...
            <div id="prop-items" className=   " col-lg-6  px-5 py-4"><img className="w-100 " src="/img1.jpg" ></img></div>
            ...
            <div id="prop-items" className=   " col-lg-6  px-5 py-4"><img className="w-100 " src="/propties.jpg" ></img></div>
            ...
            <div className="col-lg-6  px-5  py-2">
                ...
                <p className="">We wear the helmet and bring your vision to life. At UR9 Construction,
